...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-tertiary dark:bg-tertiary/30 p-1 text-primary dark:text-primary",
      className
    )}
    {...props}
  />
