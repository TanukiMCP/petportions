...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-16 md:py-24 overflow-hidden bg-background dark:bg-gray-900">
      <motion.div
      ...
      >
        ...
        >
          <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-background/80 dark:bg-gray-800/80 border-2 border-primary/20 dark:border-primary/20 backdrop-blur-sm">
